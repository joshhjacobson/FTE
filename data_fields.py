...
images.append(grid[0].imshow(apcp_fcst_ens[iday_gefs,5,::-1,:],cmap=BuPu,extent=extentf,vmax=52.))
...
images.append(grid[1].imshow(fcst_dwnsc[5,::-1,:],cmap=BuPu,extent=extentf,vmax=52.))
...
fig.savefig('gefs_fields.png', dpi=300, bbox_inches='tight')
